...
{
    public class MappingForE075PRO1 : IEntityTypeConfiguration<E075PRO1>
    {
        public void Configure(EntityTypeBuilder<E075PRO1> entity)
        {
            entity.HasKey(e => new { e.Codemp, e.Codpro })
                .HasName("cp_e075pro")
                .IsClustered(false);

            entity.ToTable("e075pro", "sapiens", tb => tb.HasTrigger("t075prod"));

...
{
    public class MappingForE085cli : IEntityTypeConfiguration<E085CLI>
    {
        public void Configure(EntityTypeBuilder<E085CLI> entity)
        {
            entity.HasKey(e => e.Codcli)
                .HasName("cp_e085cli")
                .IsClustered(false);

            entity.ToTable("e085cli", tb =>
            {
            ...
            entity.Property(e => e.Catest)
                .HasMaxLength(3)
                .IsUnicode(false)
                .HasColumnName("catest");
            ...
            entity.Property(e => e.UsuObscli)
                .HasMaxLength(999)
                .IsUnicode(false)
                .HasColumnName("usu_obscli");
            entity.Property(e => e.UsuObsfin)
                .HasMaxLength(250)
                .IsUnicode(false)

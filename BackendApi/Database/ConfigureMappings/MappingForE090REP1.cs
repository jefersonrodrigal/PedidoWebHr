...
{
    public class MappingForE090REP1 : IEntityTypeConfiguration<E090REP1>
    {
        public void Configure(EntityTypeBuilder<E090REP1> entity)
        {
            {
                ...
                entity.ToTable("e090rep", "sapiens", tb =>
                {

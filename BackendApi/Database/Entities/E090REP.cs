...
public partial class E090REP
{
    public int Codrep { get; set; }

    public string Nomrep { get; set; } = null!;

    public string Aperep { get; set; } = null!;

    public string? Senrep { get; set; }

    public string Tiprep { get; set; } = null!;
    ...
    public string Endrep { get; set; } = null!;

    public string? Cplend { get; set; }

    public string? Zipcod { get; set; }

    public int? Ceprep { get; set; }
    ...
    public string Sitrep { get; set; } = null!;

    public short? Qtddep { get; set; }
    ...
    public short? UsuAterep { get; set; }

    public short? UsuCodrgn { get; set; }

    public short? UsuCodcrd { get; set; }
    ...
    public string? Firind { get; set; }

    public long? UsuCgccpf { get; set; }

    public string? UsuEndrep { get; set; }

    public string? UsuCplend { get; set; }

    public int? UsuCeprep { get; set; }

    public string? UsuBairep { get; set; }

    public string? UsuCidrep { get; set; }

    public string? UsuSigufs { get; set; }

    public string? UsuNenrep { get; set; }

    public string? Numidf { get; set; }

    public string? Intwmw { get; set; }
